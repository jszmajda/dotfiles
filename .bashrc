...
# for examples
if [[ -s /home/josh/.rvm/scripts/rvm ]] ; then source /home/josh/.rvm/scripts/rvm ; fi
...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[00;37m\]\u\[\033[01;30m\]@\[\033[01;37m\]\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\] '
else
...
export PATH=/var/lib/gems/1.8/bin:$PATH:/home/josh/node_modules/.bin
alias gs='git status'
...
. ~/.bash_secure
export AWS_KEY_PAIR=kp-2011-05-02
export AWS_SSH_KEY=$HOME/Documents/ec2/kp-2011-05-02.pem
